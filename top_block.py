...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0 = osmosdr.source(args="numchan=" + str(2) + " " + 'uhd=318F1BF' ) 
        self.osmosdr_source_0.set_clock_source('external', 0)
        self.osmosdr_source_0.set_time_source('external', 0)
        self.osmosdr_source_0.set_sample_rate(samp_rate)
        self.osmosdr_source_0.set_center_freq(2.42e9, 1)
        ...
        self.osmosdr_sink_0 = osmosdr.sink(args="numchan=" + str(2) + " " + "uhd=318F1BF" ) 
        self.osmosdr_sink_0.set_clock_source('external', 0)
        self.osmosdr_sink_0.set_sample_rate(samp_rate)
        self.osmosdr_sink_0.set_center_freq(2.42e9, 1)
