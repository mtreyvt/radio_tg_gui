...
#----------------------------------------------------------------------------
        ...
        if numSamples != None:
            self.vector_sink_1 = blocks.vector_sink_f(1,numSamples)                          #===================
            self.vector_sink_0 = blocks.vector_sink_f(1,numSamples)        
            self.blocks_head_1 = blocks.head(gr.sizeof_float, numSamples)                    #===================
            self.blocks_head_0 = blocks.head(gr.sizeof_float, numSamples)
        else:
            self.vector_sink_1 = blocks.vector_sink_f(1,1000)                                #===================
...
### receiver connections ###
        ...
        self.connect((self.blocks_complex_to_float_0, 1), (self.low_pass_filter_1, 0))       #===================
        self.connect((self.blocks_complex_to_float_0, 0), (self.low_pass_filter_0, 0))    
        self.connect((self.dc_blocker_xx_1, 0), (self.vector_sink_1, 0))                     #===================
        ...
        if numSamples != None:
            self.connect((self.dc_blocker_xx_1, 0), (self.blocks_head_1, 0))                 #===================
...
### end receiver connections ###
        ...
        print("frequency: {first}".format(first=self.frequency))
        return
